...
public class SummonChargeState : AnimationState
{
    ...
    {
        // Transition: SummonCharge -> SummonLoop once the animation has finished
        if (stateMachine._animator.GetCurrentAnimatorStateInfo(0).normalizedTime >= 1.0f)
        {
            ...
            stateMachine.SwitchState(stateMachine.SummonLoopState);
        }
    }
}
